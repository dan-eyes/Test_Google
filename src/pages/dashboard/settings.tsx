    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {['General', 'Regions', 'Currencies', 'Taxes', 'Shipping', 'Team', 'API Keys', 'Sales Channels'].map((setting) => (
          <div key={setting} className="bg-white dark:bg-[#09090B] border border-zinc-200 dark:border-zinc-800 rounded-lg p-4 shadow-sm hover:border-zinc-300 dark:hover:border-zinc-700 transition-colors cursor-pointer group">
