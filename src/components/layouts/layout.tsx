  ...
  return (
    ...
    <div className={cn(
      ...
      <div className={cn(
        ...
        <DocsSidebar className="w-full h-full border-r border-zinc-200 dark:border-zinc-700" />
      </div>
      ...
      <main className="flex-1 flex flex-col h-full min-w-0 p-2 lg:py-3 lg:pr-3 pl-0 md:pl-2 transition-all duration-300 relative">
        ...
        <div className="flex-1 flex flex-col bg-white dark:bg-[#18181B] rounded-[1rem] lg:rounded-[1.5rem] shadow-sm border border-zinc-200 dark:border-zinc-700/80 overflow-hidden relative">
          
          {/* HEADER DELLA SCHEDA */}
          <header className="h-14 flex-shrink-0 border-b border-zinc-200 dark:border-zinc-700/80 flex items-center justify-between px-4 lg:px-6 z-20 bg-white dark:bg-[#18181B]">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative group">
                ...
                <div className="absolute right-0 top-full mt-1 w-48 bg-white dark:bg-[#27272A] border border-zinc-200 dark:border-zinc-700/80 rounded-xl shadow-xl py-1.5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50">
              ...
              <div className="relative group hidden sm:block">
                ...
                <div className="absolute right-0 top-full mt-1 w-52 bg-white dark:bg-[#27272A] border border-zinc-200 dark:border-zinc-700/80 rounded-xl shadow-xl py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50">
                  ...
                  <div className="my-1 border-t border-zinc-100 dark:border-zinc-700/80"></div>
