...
export function DashboardLayout() {
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] dark:bg-[#09090B] font-sans text-zinc-900 dark:text-zinc-100 flex">
      
      {/* --- SIDEBAR (Fixed Left) --- */}
      <aside className="w-[240px] bg-white dark:bg-[#09090B] border-r border-zinc-200 dark:border-zinc-800 flex-shrink-0 flex flex-col h-screen sticky top-0 z-30">
        
        {/* Store Selector / Logo Area */}
        <div className="h-14 flex items-center px-4 border-b border-zinc-200 dark:border-zinc-800">
          <div className="flex items-center gap-2 w-full p-1.5 rounded-md hover:bg-zinc-50 dark:hover:bg-zinc-800/50 cursor-pointer transition-colors group">
        ...
        <div className="p-3 border-t border-zinc-200 dark:border-zinc-800 space-y-1">
          ...
          <button className="w-full flex items-center gap-3 px-3 py-2 rounded-md text-[13px] font-medium text-zinc-500 hover:bg-zinc-50 hover:text-zinc-900 dark:text-zinc-400 dark:hover:bg-zinc-800/50 dark:hover:text-zinc-50 transition-colors">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        {/* --- TOP HEADER --- */}
        <header className="h-14 bg-white dark:bg-[#09090B] border-b border-zinc-200 dark:border-zinc-800 flex items-center justify-between px-6 sticky top-0 z-20">
          ...
          <div className="flex items-center gap-3">
            <button className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-500 dark:text-zinc-400 transition-colors relative border border-transparent hover:border-zinc-200 dark:hover:border-zinc-700">
            ...
            <button className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-500 dark:text-zinc-400 transition-colors border border-transparent hover:border-zinc-200 dark:hover:border-zinc-700">
              <HelpCircle className="w-4 h-4" />
            </button>
            <div className="h-6 w-[1px] bg-zinc-200 dark:bg-zinc-800 mx-1"></div>
            <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-blue-600 to-indigo-600 border border-white dark:border-zinc-800 shadow-sm cursor-pointer hover:ring-2 hover:ring-zinc-100 dark:hover:ring-zinc-800 transition-all flex items-center justify-center text-white text-[10px] font-bold">
              JD
            </div>
          </div>
        </header>
